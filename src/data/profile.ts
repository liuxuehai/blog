...
export function getProfileData(locale: string) {
	...
	return {
		profile: {
			name: "Max",
			role: isZh ? "资深Java工程师 & 软件架构师" : "Senior JAVA Engineer & Software Architect",
			intro: isZh
			...
			email: isZh ? "453923278@qq.com" : "liuxuehai2023@gmail.com",
		},
		focusAreas: [
			{
		...
		professionalWork: [
			{
				...
				role: isZh ? "技术负责人 / 资深Java工程师" : "Technical Lead / Senior JAVA Engineer",
				description: isZh
			...
			},
			{
				...
				description: isZh
					? "参与核心系统架构治理、领域拆分、微服务改造和双活方案，推进监控、代码规范、架构评审与 Code Review。"
			...
			},
			{
				...
				role: isZh ? "资深Java工程师" : "Senior JAVA Engineer",
				description: isZh
